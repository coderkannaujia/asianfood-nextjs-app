  ...
  return (
    <div className="h-full w-[1270px] mx-auto p-4 sm:w-[1300px] md:w-[1200px] lg:w-[1300px] xl:w-[2000px]  bg-lime-400 ">
      <div className="flex justify-between mt-14">
        <div>
          <a href="#" className="font-bold  md:text-xl ml-20">
            Asian food
          </a>
        ...
        <div>
          ...
          <h1 href="#" className="mt-4 font-semibold">
            FAQ
          </h1>
          <h1 href="#" className="mt-4  font-semibold ">
            Contact
      ...
      <div className="h-1 bg-gray-400 mt-20"></div>

      <h1 className=" mt-20  text-center font-bold text-xl">
